-- ============================================================
-- 009_seed_vc_tables.sql
-- Seeds all program data into VC_ prefixed tables
-- ============================================================

-- Categories
INSERT INTO public.VC_categories (id, slug, label, sort_order) VALUES
...
-- Programs
INSERT INTO public.VC_programs (id, slug, name, tagline, short_description, long_description, category, category_slug, color, badge, duration, audience, leaders, sort_order, is_active) VALUES
  (
...
INSERT INTO public.VC_program_phases (id, program_id, letter, name, days, description, sort_order) VALUES
...
-- Program Features
-- Youth Leadership Launchpad
INSERT INTO public.VC_program_features (id, program_id, icon, title, description, sort_order) VALUES
...
-- Program Pricing
-- Youth Leadership
INSERT INTO public.VC_program_pricing (id, program_id, tier, name, subtitle, price, original_price, price_note, features, cta_label, cta_href, highlighted, sort_order) VALUES
...
-- Sample Office Hours for Workforce Ready
INSERT INTO public.VC_office_hours (program_id, title, description, meeting_url, scheduled_at, duration_minutes, status)
SELECT 
  p.id,
