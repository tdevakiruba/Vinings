...
export function HeroAnimation() {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(30,58,138,0.12),transparent)]" />
      ...
      {/* Animated orbs */}
      <div className="absolute left-1/4 top-1/4 size-96 animate-pulse rounded-full bg-[#1e3a8a]/5 blur-3xl" />
